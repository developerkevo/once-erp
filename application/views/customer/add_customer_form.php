                ...
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="panel-body">
                        <div class="col-sm-6">
                            ...
                            <div class="form-group row">
                                <label for="emailaddress" class="col-sm-4 col-form-label"><?php echo display('address'); ?> <i class="text-danger"></i></label>
                                <div class="col-sm-8">
                                    <input class="form-control" name="emailaddress" id="emailaddress" type="text" placeholder="<?php echo display('address') ?>">
                                </div>
                            </div>
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-group row">
                                <label for="bank_account" class="col-sm-4 col-form-label"><?php echo display('bank_account'); ?> <i class="text-danger"></i></label>
                                <div class="col-sm-8">
                                    <input class="form-control" name="bank_account" id="bank_account" type="text" placeholder="<?php echo display('bank_account') ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <select class="form-control" name="customer_type" id="customer_type" tabindex="-1" aria-hidden="true" style="width:100%;">
                            ...
                            <div class="form-group row">
                                <label for="route_id" class="col-sm-4 col-form-label"><?php echo display('route'); ?> <i class="text-danger"></i></label>
                                <div class="col-sm-8">
                                    <select class="form-control" name="route_id" id="route_id" tabindex="-1" aria-hidden="true" style="width:100%;">
                                        <?php
                                        foreach ($routes as $r) { ?>

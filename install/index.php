...
<title>SRP Application Installer</title>
    ...
    <div class="container"> 
        ...
        <div class="row"> 
            <div class="col-md-10 col-md-offset-1 col-sm-10 col-sm-offset-1"> 
                <header class="header">
                    <h1 class="header-title">SRP software installer</h1>
                </header>
...
<footer class="footer text-center">
    <div class="container fText">
        <div class="col-md-10 col-md-offset-1 col-sm-10 col-sm-offset-1">
            <div class="row">
                <div class="col-sm-6 text-left">Developed by <a  target="_blank" href="https://wa.me/254714093742">Kevin</a></div>
                <div class="col-sm-6  text-right"><a target="_blank" href="https://wa.me/254714093742/"><span class="glyphicon glyphicon-user"></span> Installation Support</a></div>
            </div>
        </div>
    </div>
</footer>
